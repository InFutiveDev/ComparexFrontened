...
const faqs = [
    {
        question: "What exactly does CompareX do?",
        answer:
            "CompareX helps businesses compare payment gateways and fintech solutions side-by-side based on pricing, onboarding ease, support quality, features, integrations, settlement cycles, and business suitability - all in one place.",
    },
    {
        question: "Is CompareX a payment gateway?",
        answer:
            "No. CompareX is a neutral discovery and advisory platform. We do not process payments or hold merchant funds.",
    },
    {
        question: "How does CompareX recommend the right PG for my business?",
        answer:
            "Our system considers your business model, monthly volume, risk profile, integration needs, onboarding urgency, and operational priorities to suggest relevant providers.",
    },
    {
        question: "Can CompareX help if my PG application was rejected earlier?",
        answer:
            "Yes. CompareX helps businesses identify onboarding gaps and connect with providers better aligned with their category and requirements.",
    },
    {
        question: "Will CompareX help during onboarding?",
        answer:
            "Yes. CompareX supports businesses from discovery to onboarding coordination and helps simplify the overall activation journey.",
    },
    {
        question: "Can I talk to someone before choosing a provider?",
        answer:
            "Absolutely. Merchants can ‘Talk to Expert’ representatives directly through the platform.",
    },
    {
        question: "Is CompareX free for businesses?",
        answer:
            "Yes. Comparing providers, exploring resources, and receiving recommendations is free for merchants.",
    },
    {
        question: "How is CompareX different from searching on Google?",
        answer:
            "Instead of browsing dozens of provider websites individually, CompareX brings structured comparisons, merchant reviews, onboarding insights, and expert assistance into one simplified experience.",
    },
