...
const whyBusinessItems = [
  ...
  {
    title: "Growing network of trusted providers",
    
  },
];

export function WhyBusinessesSection() {
  return (
    <section className="bg-[#f2f6fb] px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
      <div className="mx-auto grid max-w-8xl grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-14">
        ...
        <div>
          ...
          Why Businesses Trust CompareX

          </h2>
          {/* <p className="mt-3 text-base leading-relaxed text-slate-600 sm:text-lg">
            A free, unbiased platform built to help merchants compare payment gateways with
            clarity — not sales pressure.
          </p> */}

          <ul className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
            {whyBusinessItems.map((item) => (
              <li
                key={item.title}
