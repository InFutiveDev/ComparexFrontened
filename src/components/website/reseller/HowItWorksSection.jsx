...
const steps = [
  {
    step: 1,
    label: "Refer",
    title: "Submit a business lead.",
    Icon: HiShare,
  },
  {
    step: 2,
    label: "Match",
    title: "We connect them with relevant providers.",
    Icon: HiSquares2X2,
  },
  {
    step: 3,
    label: "Support",
    title: "We assist through the onboarding & activation process.",
    Icon: HiClipboardDocumentCheck,
  },
  {
    step: 4,
    label: "Earn",
    title: "Receive commissions on successful transactions.",
...
export function ResellerHowItWorksSection() {
  return (
      ...
      <div className="mx-auto max-w-8xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-6 text-3xl font-bold leading-tight tracking-tight text-slate-900 sm:text-4xl">
            Four Simple Steps to Reseller Success
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-slate-600 sm:text-lg">
            From registering as a partner to tracking commissions — CompareX simplifies your
            entire reseller journey.
          </p>
        </div>
