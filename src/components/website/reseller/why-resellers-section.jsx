...
const promoSlides = [
  {
    id: "submit-leads",
    title: "Submit Leads in One Place",
...
const whyResellerItems = [
  {
    title: "One Partnership. Multiple Payment Gateways.",
    description:
      "Access multiple payment gateways through a single trusted partnership.",
  },
  {
    title: "Higher Conversion.",
    description:
      "Connect with merchants that best fit your partner payment gateways.",
  },
  {
    title: "We Handle Onboarding Support.",
    description:
      "We assist merchants throughout onboarding and activation.",
  },
  {
    title: "Transparent Lead Tracking.",
    description:
      "Track referrals, conversions, and earnings in one place.",
  },
  {
    title: "Better Commercials.",
    description:
      "Help businesses access competitive pricing and better deals.",
  },
];

export function WhyResellersSection() {
  return (
      ...
      <div className="mx-auto grid max-w-8xl grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-14">
        ...
        <div>
          <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">
            Why Partner / Resellers Choose CompareX
          </h2>

          <ul className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
            {whyResellerItems.map((item) => (
              <li
                key={item.title}
              ...
              >
                <span
                  className="mt-2 block size-1.5 shrink-0 rounded-full bg-[#2D4CC8]"
                  aria-hidden
                />
                <div>
