...
import { TopResellersSection } from "@/components/dashboard/reseller/top-resellers-section";
...
export function ResellerSection() {
  ...
  return (
    <div className="space-y-4">
      ...
      <TopResellersSection rows={listState.data} isLoadingRows={listState.isLoading} />
