...
export function StatsCards({ stats }) {
  ...
  return (
    <section className="space-y-5 bg-white border border-gray-200 rounded-lg p-4">
        ...
        {stats.map((stat) => (
          ...
          >
            ...
            <p className="mt-3 text-xs text-slate-500">
              {stat.previousLabel} <span className="font-medium text-slate-600">{stat.previousValue}</span>
            </p>
          </article>
        ))}
      </div>
