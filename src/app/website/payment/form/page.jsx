      ...
      <div className="relative mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="text-center">
          ...
          <h1 className="mt-5 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
            List Your Payment Gateway on CompareX
          </h1>
          <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-slate-600 sm:text-lg">
            Fill out the form below to join the CompareX marketplace. Get discovered by qualified
            merchants and grow your merchant base through a trusted platform.
          </p>
        </div>
